...
var Wallet = require("nebulas").HttpRequest
...
function testGet(address, contractAddress) {
    ...
    neb.api.call(address, contractAddress, "0", 2, "2000000", "2000000", contract).then(function (resp) {
...
describe('bankvault.' + scriptType, function() {
    ...
    describe('2. test:', function () {
        it('call test get()', function(done){
            console.log("jc test get ");

            testGet(from.getAddressString(),contractAddr);
            done();
        });
    })
});
